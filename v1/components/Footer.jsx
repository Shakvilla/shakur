  ...
  return (
      ...
      <footer className=" flex flex-wrap md:justify-between items-center px-4 sm:px-6 md:px-8 bg-gray-800 border-t border-gray-700 ">
          <div className="flex space-x-2 md:space-x-4 items-center">
              ...
              <a href="https://linkedin.com" className="text-gray-400 py-2 hover:text-white border-r border-gray-700 md:px-4" target="_blank"><FaLinkedin /></a>
          </div>
          <div className="mt-0">
              <a href="https://github.com/shakvilla" className="flex items-center gap-2 py-2 text-gray-400 hover:text-white border-l border-gray-700 md:px-4" target="_blank">
