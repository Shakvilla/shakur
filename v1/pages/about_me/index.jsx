...
import RightSidebar from '../../components/about/RightSidebar'
import LeftSidebar from '../../components/about/LeftSidebar'
            ...
            <div className="mt-0">
              ...
              <ul className="ml-4 px-2">
                <DropdownMenu isOpen={openMenu === 'bio'} toggle={() => handleMenuClick('bio')} iconColor="text-[#E99287]" label="bio">
                  <Link href="#" className="mt-2">About Me</Link>
                  <Link href="#skills" className="mt-2">Skills</Link>
                </DropdownMenu>
