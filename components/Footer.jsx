...
const Footer = () => {
  return (
      ...
      <footer className=" flex flex-wrap justify-between items-center px-4 sm:px-6 md:px-8 bg-gray-800 border-t border-gray-700 ">
          ...
          <div className="mt-4 md:mt-0">
              <a href="https://github.com/shakvilla" className="flex items-center gap-2 py-2 text-gray-400 hover:text-white border-l border-gray-700 px-4" target="_blank">@shakvilla <FaGithub /></a>
          </div>
      </footer>
  )
}
